...
/***** Register WIS Custom Widget Areas / Sidebars *****/

if (!function_exists('wis_magazine_widgets_init')) {
    function wis_magazine_widgets_init() {
        $wis_magazine_options = mh_magazine_theme_options();
        register_sidebar(array('name' => esc_html_x('Events Sidebar', 'widget area name', 'wis-magazine'), 'id' => 'wis-sidebar', 'description' => esc_html__('Widget area (sidebar left/right) on single posts, pages and archives.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        if ($wis_magazine_options['sidebars'] == 'two') {
            register_sidebar(array('name' => sprintf(esc_html_x('Sidebar %d', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-sidebar-2', 'description' => esc_html__('Second sidebar on single posts, pages and archives.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        }
        register_sidebar(array('name' => sprintf(esc_html_x('Events Header %d - Advertisement', 'widget area name', 'wis-magazine'), 1), 'id' => 'wis-header-1', 'description' => esc_html__('Advertisement position located above the header, suitable for a single text widget.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-header-1 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Header %d - Advertisement', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-header-2', 'description' => esc_html__('Widget area on top of the site.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-header-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - Full Width', 'widget area name', 'wis-magazine'), 1), 'id' => 'wis-home-1', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-1 mh-home-wide %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 2/3 Width', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-home-2', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-2 mh-widget-col-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 3), 'id' => 'wis-home-3', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-3 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 4), 'id' => 'wis-home-4', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-4 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 2/3 Width', 'widget area name', 'wis-magazine'), 5), 'id' => 'wis-home-5', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-5 mh-widget-col-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 6), 'id' => 'wis-home-6', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-6 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - Full Width', 'widget area name', 'wis-magazine'), 7), 'id' => 'wis-home-7', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-7 mh-home-wide %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 8), 'id' => 'wis-home-8', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-8 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 9), 'id' => 'wis-home-9', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-9 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 10), 'id' => 'wis-home-10', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-10 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events %d - Full Width', 'widget area name', 'wis-magazine'), 11), 'id' => 'wis-home-11', 'description' => esc_html__('Widget area on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-11 mh-home-wide %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        if ($wis_magazine_options['sidebars'] == 'two') {
            register_sidebar(array('name' => sprintf(esc_html_x('Events %d - 1/3 Width', 'widget area name', 'wis-magazine'), 12), 'id' => 'wis-home-12', 'description' => esc_html__('Sidebar on events page.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-home-12 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        }
        register_sidebar(array('name' => sprintf(esc_html_x('Eevnts Posts %d - Advertisement', 'widget area name', 'wis-magazine'), 1), 'id' => 'wis-posts-1', 'description' => esc_html__('Widget area above single post content.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-posts-1 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Eevnts Posts %d - Advertisement', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-posts-2', 'description' => esc_html__('Widget area below single post content.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-posts-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Pages %d - Advertisement', 'widget area name', 'wis-magazine'), 1), 'id' => 'wis-pages-1', 'description' => esc_html__('Widget area above single page content.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-pages-1 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Pages %d - Advertisement', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-pages-2', 'description' => esc_html__('Widget area below single page content.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-pages-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Footer %d - 1/4 Width', 'widget area name', 'wis-magazine'), 1), 'id' => 'wis-footer-1', 'description' => esc_html__('Widget area in footer.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Footer %d - 1/4 Width', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-footer-2', 'description' => esc_html__('Widget area in footer.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Footer %d - 1/4 Width', 'widget area name', 'wis-magazine'), 3), 'id' => 'wis-footer-3', 'description' => esc_html__('Widget area in footer.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
        register_sidebar(array('name' => sprintf(esc_html_x('Events Footer %d - 1/4 Width', 'widget area name', 'wis-magazine'), 4), 'id' => 'wis-footer-4', 'description' => esc_html__('Widget area in footer.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s">', 'after_widget' => '</div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
        register_sidebar(array('name' => esc_html_x('Contact Sidebar', 'widget area name', 'wis-magazine'), 'id' => 'wis-contact', 'description' => esc_html__('Widget area (sidebar) on contact page template.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-contact %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        if ($wis_magazine_options['sidebars'] == 'two') {
            register_sidebar(array('name' => sprintf(esc_html_x('Eevents Contact Sidebar %d', 'widget area name', 'wis-magazine'), 2), 'id' => 'wis-contact-2', 'description' => esc_html__('2nd widget area (sidebar) on contact page template.', 'mh-magazine'), 'before_widget' => '<div id="%1$s" class="mh-widget mh-contact-2 %2$s">', 'after_widget' => '</div>', 'before_title' => '<h4 class="mh-widget-title"><span class="mh-widget-title-inner">', 'after_title' => '</span></h4>'));
        }
    }
}
...
// require_once('includes/wis-widgets.php');
