...
class wis_mh_magazine_carousel extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_carousel', esc_html_x('MH Carousel', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_carousel',
