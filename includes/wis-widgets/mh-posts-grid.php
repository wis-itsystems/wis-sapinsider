...
class wis_mh_magazine_posts_grid extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_grid', esc_html_x('MH Posts Grid', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_grid',
