...
class wis_mh_magazine_posts_list extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_list', esc_html_x('MH Posts List', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_list',
