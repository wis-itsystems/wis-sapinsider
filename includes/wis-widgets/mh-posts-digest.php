...
class wis_mh_magazine_posts_digest extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_digest', esc_html_x('MH Posts Digest', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_digest',
