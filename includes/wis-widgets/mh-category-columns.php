...
class wis_mh_magazine_category_columns extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_category_columns', esc_html_x('MH Category Columns', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_category_columns',
