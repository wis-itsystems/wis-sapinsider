...
class wis_mh_magazine_custom_pages extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_custom_pages', esc_html_x('MH Custom Pages', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_custom_pages',
    ...
    function update($new_instance, $old_instance) {
		...
		if (!empty($new_instance['pages'])) {
			$instance['pages'] = wis_mh_magazine_sanitize_id_list($new_instance['pages']);
		}
