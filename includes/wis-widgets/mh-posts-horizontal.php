...
class wis_mh_magazine_posts_horizontal extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_horizontal', esc_html_x('MH Posts Horizontal', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_horizontal',
