...
class wis_mh_magazine_custom_posts extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_custom_posts', esc_html_x('MH Custom Posts', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_custom_posts',
