...
class wis_mh_magazine_author_bio extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_author_bio', esc_html_x('MH Author Bio', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_author_bio',
