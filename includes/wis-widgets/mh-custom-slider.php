...
class wis_mh_magazine_custom_slider extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_custom_slider', esc_html_x('MH Custom Slider', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_custom_slider',
												...
												<?php if ($slide['excerpt']) { ?>
													<div class="mh-slider-excerpt mh-excerpt">
														...
														<a class="mh-excerpt-more" href="<?php echo esc_url($slide['url']); ?>" title="<?php echo esc_attr($slide['title']); ?>"<?php echo $link_target; ?>>
															<?php echo esc_attr($wis_mh_magazine_options['excerpt_more']); ?>
														</a>
													</div>
												<?php } ?>
											</div>
