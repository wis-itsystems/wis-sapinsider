...
class wis_mh_magazine_posts_stacked extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_stacked', esc_html_x('MH Posts Stacked', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_stacked',
