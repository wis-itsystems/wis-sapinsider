...
class wis_mh_magazine_spotlight extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_spotlight', esc_html_x('MH Spotlight', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_spotlight',
    ...
    function widget($args, $instance) {
    	$wis_mh_magazine_options = wis_mh_magazine_theme_options();
					...
					<div class="mh-spotlight-content">
						...
						<?php if ($instance['meta'] == 0) { ?>
							<p class="mh-meta mh-spotlight-meta">
								...
								<?php if ($wis_mh_magazine_options['post_meta_comments'] == 'enable') { ?>
									<span class="mh-spotlight-comments">
										<i class="fa fa-comment-o"></i><?php wis_mh_magazine_comment_count(); ?>
									</span>
								<?php } ?>
							</p>
						<?php } ?>
						<?php if ($instance['excerpt'] == 0) { ?>
							<?php wis_mh_magazine_custom_excerpt($instance['excerpt_length']); ?>
						<?php } ?>
					</div>
				</article><?php
			endwhile;
