...
class wis_mh_magazine_recent_comments extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_recent_comments', esc_html_x('MH Recent Comments', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_recent_comments',
