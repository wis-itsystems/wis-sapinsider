...
class wis_mh_magazine_posts_focus extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_focus', esc_html_x('MH Posts Focus', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_focus',
