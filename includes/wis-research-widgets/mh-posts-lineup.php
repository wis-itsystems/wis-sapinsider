...
class wis_mh_magazine_posts_lineup extends WP_Widget {
	function __construct() {
		parent::__construct(
			'wis_mh_magazine_posts_lineup', esc_html_x('MH Posts Lineup', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_posts_lineup',
								...
								<div class="mh-posts-lineup-caption">
									<div class="mh-posts-lineup-content">
										...
										if ($instance['excerpt'] === 0) {
											wis_mh_magazine_custom_excerpt($instance['excerpt_length']);
										}
						}
						if ($counter === 2) {
