...
class wis_mh_magazine_youtube extends WP_Widget {
    function __construct() {
		parent::__construct(
			'wis_mh_magazine_youtube', esc_html_x('MH YouTube Video', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'wis_mh_magazine_youtube',
