...
<div class="mh-wrapper mh-home clearfix">
    <div class="mh-main mh-home-main">
        ...
        <?php if (is_active_sidebar('wis-research-home-2') || is_active_sidebar('wis-research-home-3') || is_active_sidebar('wis-research-home-4') || is_active_sidebar('wis-research-home-5') || is_active_sidebar('wis-research-home-6')) : ?>
            <div class="mh-home-columns clearfix">
                <div id="main-content" class="mh-content mh-home-content">
                    <?php dynamic_sidebar('mh-home-2'); ?>
                    <?php if (is_active_sidebar('wis-research-home-3') || is_active_sidebar('wis-research-home-4')) : ?>
                        <div class="clearfix">
                            <?php if (is_active_sidebar('wis-research-home-3')) { ?>
                                <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-3">
                                    <?php dynamic_sidebar('mh-home-3'); ?>
                                </div>
                            <?php } elseif (is_active_sidebar('wis-research-home-4')) { ?>
                                <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-3">
                            ...
                            <?php } ?>
                            <?php if (is_active_sidebar('wis-research-home-4')) { ?>
                                <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-4">
                                    <?php dynamic_sidebar('mh-home-4'); ?>
                                </div>
                            <?php } elseif (is_active_sidebar('wis-research-home-3')) { ?>
                                <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-4">
                ...
                <?php if (is_active_sidebar('wis-research-home-6')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-6">
                        <?php dynamic_sidebar('mh-home-6'); ?>
                    </div>
                <?php } elseif (is_active_sidebar('wis-research-home-2') || is_active_sidebar('wis-research-home-3') || is_active_sidebar('wis-research-home-4') || is_active_sidebar('wis-research-home-5')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-6">
        ...
        <?php if (is_active_sidebar('wis-research-home-8') || is_active_sidebar('wis-research-home-9') || is_active_sidebar('wis-research-home-10')) : ?>
            <div class="mh-home-columns clearfix">
                <?php if (is_active_sidebar('wis-research-home-8')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-8">
                        <?php dynamic_sidebar('mh-home-8'); ?>
                    </div>
                <?php } elseif (is_active_sidebar('wis-research-home-9') || is_active_sidebar('wis-research-home-10')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-home-area-8">
                ...
                <?php } ?>
                <?php if (is_active_sidebar('wis-research-home-9')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-9">
                        <?php dynamic_sidebar('mh-home-9'); ?>
                    </div>
                <?php } elseif (is_active_sidebar('wis-research-home-8') || is_active_sidebar('wis-research-home-10')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-9">
                ...
                <?php } ?>
                <?php if (is_active_sidebar('wis-research-home-10')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-10">
                        <?php dynamic_sidebar('mh-home-10'); ?>
                    </div>
                <?php } elseif (is_active_sidebar('wis-research-home-8') || is_active_sidebar('wis-research-home-9')) { ?>
                    <div class="mh-widget-col-1 mh-sidebar mh-home-sidebar mh-margin-left mh-home-area-10">
    ...
    <?php if ($mh_magazine_options['sidebars'] == 'two') { ?>
        <div class="mh-widget-col-1 mh-sidebar-2 mh-home-sidebar-2 mh-sidebar-wide"><?php
            if (is_active_sidebar('wis-research-home-12')) {
